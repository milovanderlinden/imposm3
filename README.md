...
Testing with a small planet
    ...
    bin/imposm3 import -connection postgis://username:pass@localhost/imposm3 -mapping src/imposm3/basemaps-mapping.json -read planet-curacao-131115.osm.pbf -write=true -overwritecache
